...
public class KafkaConverterTest {
   ...
   @Test
    void byteTest() {
       ...
       assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(Byte.class)
    ...
    void shortTest() {
        ...
        assertThat(schemaAndValue.value()).isEqualTo(expectedValue);
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(Short.class)
                .isEqualTo(expectedValue);
    }
    ...
    void intTest() {
        ...
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(Integer.class)
                .isEqualTo(128);
    }
    ...
    void longTest() {
        ...
        assertThat(schemaAndValue.value()).isEqualTo(expectedValue);
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(Long.class)
                .isEqualTo(expectedValue);
    }
    ...
    void floatTest() {
        ...
        assertThat(schemaAndValue.value()).isEqualTo(expectedValue);
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(Float.class)
                .isEqualTo(expectedValue);
    }
    ...
    void doubleTest() {
        ...
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(Double.class)
                .isEqualTo(12.8);
    }
    ...
    void bigDecimalTest() {
        ...
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(BigDecimal.class)
                .isEqualTo(expectedValue);
    }
    ...
    void bigIntegerTest() {
        ...
        assertThat(schemaAndValue.schema().type()).isEqualTo(Schema.Type.STRING);
        assertThat(schemaAndValue.value()).isEqualTo(expectedValue.toString());
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(BigInteger.class)
                .isEqualTo(expectedValue);
    }
    ...
    void stringTest() {
        ...
        assertThat(schemaAndValue.value()).isEqualTo(expectedValue);
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(String.class)
                .isEqualTo(expectedValue);
    }
    ...
    void booleanTest() {
        ...
        assertThat(schemaAndValue.value()).isEqualTo(expectedValue);
        assertThat(underTest.decode(schemaAndValue)).isPresent().get().isInstanceOf(Boolean.class)
                .isEqualTo(expectedValue);
    }
    ...
    void notKafkaTypeTest() {
        ...
        Schema expectedSchema = new SchemaBuilder(Schema.Type.STRING).name(UUID.class.getCanonicalName()).build();
