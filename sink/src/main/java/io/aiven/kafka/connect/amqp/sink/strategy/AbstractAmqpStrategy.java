...
public abstract class AbstractAmqpStrategy implements Strategy {
    ...
    @VisibleForTesting
    final ConcurrentSkipListMap<KafkaRecordKey, TrackerSinkRecord> commitMap;
    ...
    abstract Message<?> createClientMessage(SinkRecord sinkRecord) throws AmqpParseException, ClientException;
    ...
    public void flush(Map<TopicPartition, OffsetAndMetadata> currentOffsets) {
        LoggerFactory.getLogger(this.getClass()).error("flush() Should not be called from the AmqpBodyFmt strategy");
    }
